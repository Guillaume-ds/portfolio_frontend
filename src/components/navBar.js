...
const NavBar = () =>{
    ...
    return(
      <nav class="px-2 border-gray-200  navBar">
				<div class="container flex flex-wrap justify-between items-center mx-auto">

					<a href="/" class="flex items-center">
						<span class="self-center ml-5 text-2xl lg:text-4xl font-bold whitespace-nowrap navName">
					...
					<button data-collapse-toggle="mobile-menu" type="button" 
						onClick={()=>checkHidden()}
						class="inline-flex justify-center items-center ml-3 
					...
					<div class={"w-full md:block md:w-auto px-5 " + isHidden}  id="mobile-menu">						
						<PageNav navBar={true} />
					</div>
				</div>
			</nav>
