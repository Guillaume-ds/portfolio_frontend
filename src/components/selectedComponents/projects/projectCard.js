      ...
      <div className="mx-4 my-6 md:m-0 md-w-full bg-white rounded-lg border border-gray-200 shadow-md">
				...
				<div className="px-5 py-1 h-64">
					<div className="my-2">
						...
						<a href={"/projects/"+project.slug} className="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
							Read more
